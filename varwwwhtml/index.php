      ...
      <div id="share-query" class="tooltip">
       ...
       <form action="index.php" method="POST" id="queryForm">
	    ...
	    <table style="margin-left:auto;margin-right:auto;float:left;">
          ...
          <tr><td><div class="tooltip">max. distance:<span class="tooltiptext" style="top:125%;bottom:auto;left:80pt">maximum distance from search coordinates [arcsec]</span></div></td><td><input size="4" type="text" name="dist" value="<?php echo $dist;?>"> arcsec</td></tr>	      
          ...
          <tr><td style='text-align:right'><input size="8" type="text" name="detlikemin" value="<?php echo $detlikemin;?>"></td><td style='text-align:center'> < <div class="tooltip">DET_LIKE_0<span class="tooltiptext" style="left:84pt;bottom:16pt">DET_LIKE = scaled sum of membership probabilities</span></div> &#8804 </td><td style='text-align:left'><input size="8" type="text" name="detlikemax" value="<?php echo $detlikemax;?>"></td></tr>
          ...
          <tr><td style='text-align:right'><input size="8" type="text" name="extlikemin" value="<?php echo $extlikemin;?>"></td><td style='text-align:center'> < <div class="tooltip">EXT_LIKE<span class="tooltiptext" style="left:92pt;bottom:16pt">fraction of masked area</span></div> &#8804; </td><td style='text-align:left'><input size="8" type="text" name="extlikemax" value="<?php echo $extlikemax;?>"></td></tr>
	...
	<div class="clusters">
	  ...
	  <?php
	   ...
	   if ( (count($_GET) == 0) && !isset($_POST['submit']) ){
               ...
               if ($detlikemin != "")                                                                                                                                              
                   $query .= " DET_LIKE > {$detlikemin} AND";                                                                                                                   
               if ($detlikemax != "")                                                                                                                                              
                   $query .= " DET_LIKE <= {$detlikemax} AND";                                                                                                                  
	...
	<div class="members"><!-- ~ Valerio - this is where the members begin -->
	  ...
	  <?php
           ...
           echo "<th data-sort='float'>w2</th>";
            echo "<th data-sort='float'>GG</th>";
            echo "<th data-sort='float'>BP</th>";
            echo "<th data-sort='float'>RP</th>";
